...
public class thing : MonoBehaviour
{
    ...
    static public thing Create(string name, float x, float y, float z, float ex, float ey, float ez, float scale_, bool kinematic)
    {
        ...
        gameObject.GetComponent<thing>().scale = scale_;
